...
import com.thomasvitale.multitenant.app.advanced.TestMariadbApplication;
...
@TestPropertySource(locations="classpath:instrumentsTestForMariaDB.properties")
@Import(value= {
		TestMariadbApplication.class,
		InstrumentTestConfig.class,
		SecurityConfig.class ,
		InstrumentTestDataConfig.class})
public class InstrumentControllerTest04 extends AbstractInstrumentControllerTests{
