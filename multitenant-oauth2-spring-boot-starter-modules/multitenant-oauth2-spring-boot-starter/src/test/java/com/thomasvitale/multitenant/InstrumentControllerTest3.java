...
//		TestPostgresApplication.class,
		...
		InstrumentTestConfig.class,SecurityConfig.class ,InstrumentTestDataConfig.class})
public class InstrumentControllerTest3 extends AbstractInstrumentControllerTests{
