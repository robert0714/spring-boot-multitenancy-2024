...
import com.thomasvitale.login.aggregate.LoginInputDto.LoginInputDtoBuilder;
...
//		objectMapper = new ObjectMapper();
	...
	public void testVerifyCaptcha() throws Exception {
		...
		LoginInputDtoBuilder bullder = LoginInputDto.builder();
		
		bullder.passwd("unittest")
		       .userName("unittest")
		       .catchpa(catchValue)
		       .token(token);
		
		LoginInputDto body = bullder.build();
	...
	public void testVerifyCaptcha401() throws Exception {
		...
		LoginInputDto body = LoginInputDto.builder().passwd("unittest").userName("unittest2").catchpa(catchValue).token(token).build();
