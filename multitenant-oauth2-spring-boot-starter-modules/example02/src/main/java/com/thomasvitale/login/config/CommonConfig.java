...
//	}
	...
	@Bean 
	public PropertiesTenantDetailsService propertiesTenantDetailsService (TenantDetailsProperties tenantDetailsProperties) {
		return new PropertiesTenantDetailsService(tenantDetailsProperties);
	}  

	@Bean
	public TenantContextFilter tenantContextFilter(final HttpHeaderTenantResolver httpRequestTenantResolver,
			final TenantDetailsService tenantDetailsService) {
		return new TenantContextFilter(httpRequestTenantResolver, tenantDetailsService);
	}
}
